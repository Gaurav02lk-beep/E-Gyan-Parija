...
import FeaturedBookSummary from '../../components/FeaturedBookSummary';
...
const BookDetailModal: React.FC<{ 
    ...
    const handleGenerateSummary = async () => {
        ...
        context?.trackAISummary(book.id);
    ...
    const handleDownload = () => {
        context?.trackDownload(book.id);
        alert(`Downloading "${book.title}"... (mock)`);
    };
                        ...
                        <div className="mt-auto space-y-3 pt-4">
                           {book.price && !userOwnsBook ? (
                                ...
                                <div className="flex space-x-3">
                                    ...
                                    <button onClick={handleDownload} className="flex-1 bg-white dark:bg-slate-700 dark:hover:bg-slate-600 dark:text-slate-200 border border-slate-300 dark:border-slate-600 hover:bg-slate-100 text-slate-700 font-semibold py-3 px-4 rounded-md transition">Download</button>
                                </div>
                           ) : (
